    ...
    return (
        ...
        <Navbar>
            <a className="flex items-center hovesr:opacity-75 ltr:mr-auto rtl:ml-auto" href="/">
                ...
                <span className="max-md:hidden select-none font-extrabold ltr:ml-2 rtl:mr-2" title="deepfacial.github.io: Gesture Generation Research Community">
                    DeepFacial
                </span>
            </a>
            ...
            <a
                href="https://deepfacial.pages.dev"
                target="blank"
                rel="blank"
            ...
            <a href="https://github.com/DeepFacial" target="blank" rel="noreferrer">
                <Github />
